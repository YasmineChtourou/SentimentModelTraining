...
def lstmModel(embedding_matrix,epoch):
    ...
    history = model.fit(X_train, y_train, validation_split=VALIDATION_SPLIT, epochs=epoch, batch_size=128,callbacks=[EarlyStopping(patience=3)])
...
model = lstmModel(embedding_mat,50)
